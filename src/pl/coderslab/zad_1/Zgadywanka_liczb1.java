...
public class Zgadywanka_liczb1 {
    ...
    private static void play (Scanner scanner) {
        ...
        System.out.println("Wylosowana przez komputer liczba to: "+number);
        System.out.println("################################################");
        System.out.println("Witaj w grze! Komputer losuje liczbę z zakresu 1-100. Zgadnij liczbę:");
